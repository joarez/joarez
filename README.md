# 👋 Olá, eu sou Joarez Rosa

## Senior QA Engineer | Test Automation | Software Quality

Engenheiro de Qualidade com foco em testes manuais e automatizados para aplicações web e mobile, atuando na construção de soluções de automação, aumento da cobertura de testes e melhoria contínua da qualidade de software.

Experiência com automação E2E, testes de APIs, pipelines CI/CD e validação de fluxos críticos, contribuindo para entregas mais estáveis, confiáveis e eficientes.
...
- 🚀 Redução de até **55% no tempo de validação**
- 🔥 Aumento de **100% da cobertura automatizada em cenários críticos**
- ✅ Melhoria da confiabilidade das entregas e eficiência dos ciclos de testes
...
Projeto de automação de testes de APIs utilizando Postman e validações automatizadas.

## 🔹 Mobile Automation

Automação mobile com Appium para aplicações Android e iOS.
